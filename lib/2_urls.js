...
module.exports = params => {
    ...
    return new Promise(resolve => {
        ...
        if (
            typeof params.tvmaze_id !== 'undefined'
        ) {
            types.push('tvmaze');
        }
            ...
            if (season && typeof season === 'object') {
                season.map(season => {
                    data.push({
                        ...
                        url: 'https://api.tvmaze.com/shows/' + params.tvmaze_id + '?embed[]=episodes&embed[]=cast&embed[]=crew&embed[]=akas'
                    });
                });
            } else {
                data.push({
